...
func _ready():
	...
	# Connect buttons
	$CenterContainer/VBoxContainer/PracticeBattleButton.connect("pressed", _on_practice_battle_pressed)
	...
	$CenterContainer/VBoxContainer/ShipInfoLabel.text = "Your Ship: %s" % ship_names[config["ship_class"]]
